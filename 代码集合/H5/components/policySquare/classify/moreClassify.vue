<template>
  <div class="filtrate">
    <div class="filtrate-wrapper-more">
...
export default {
  ...
  methods: {
    handleCheckedindustryClassify(val) {
      ...
      console.log(this.resultList, "输出按标题相关ya");
      this.$emit(
        "industry-change",
        this.resultList,
...
.filtrate-wrapper-more {
  padding: 0rem 0.4rem 0.05rem 0.4rem;
}

.filtrate-title:nth-of-type(1) {
 margin-top: 0.1rem;
}
