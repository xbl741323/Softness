<template>
  <div>
    ...
    <div class="footer" @touchmove.prevent>
      <div class="service_float" v-if="showStatus == true">
      ...
      <div class="policy_float" v-if="showService">
        <span class="angle_pointer"></span>
        <ul>
    ...
    <div class="foa" v-if="String($route.path).indexOf('/member') == -1 && String($route.path).indexOf('/classification') == -1">
...
export default {
  ...
  methods: {
    ...
    watchRoute(){
      ...
      String(this.$route.path).indexOf("/classification") != -1  ||
