<template>
  <div class="container">
    ...
    <mt-button class="container-button" @click="changePhoNum">确认修改</mt-button>
...
export default {
  ...
  methods: {
    // 手机号码格式校验this.$store.state.userInfo.accountNo
    checkPho() {
      let reg = /^1[3-9]\d{9}$/;
      if (reg.test(this.userPho.trim())) {
