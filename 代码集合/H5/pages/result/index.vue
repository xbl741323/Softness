...
import nuticeHeader from "@/components/technology/resultHeader";
export default {
  name: "projectList",
  components: {
    nuticeHeader,
    ...
    return {
      ...
      meta: [
        ...
        },
        {
          ...
          name: "description",
          content:
            "卧涛网-国内专业的技术转让、科技成果转化、技术交易服务平台。提供科技成果转让、成果鉴定、技术转让等服务。快速资源对接，大平台服务质量有保障，签订保密协议。"
        }
      ],
    };
  },
