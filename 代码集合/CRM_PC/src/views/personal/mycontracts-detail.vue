<template>
  <div class="contracts">
    ...
    <div class="top-detail">
          ...
          <td>
            ...
            >
              <span
                ...
                >{{ data.contractStatus | contractsStatus }}</span
              >
            </el-tooltip>
            <div v-else>
              <span
      ...
      <div
        class="topBtn"
        v-if="data.loginEmpNo == data.saleBelongNo && data.contractStatus == 3"
      >
        <el-button type="primary" @click="updateContracts">{{
          $t("button.updateContracts")
        }}</el-button>
        <el-button type="primary" class="delete" @click="delContracts">{{
          $t("button.deleteContracts")
        }}</el-button>
      </div>
    </div>
...
import orderInfo from "@/components/personal/contracts/offline-order-info";
import { auditingOption } from "@/const/crud/personal/auditing";
import {
  getMyContractsDetail,
  contractsDelete,
  downloadLog,
  operateRecords,
} from "@/api/personal/mycontracts";
import { getUUID,updateNote } from "@/api/personal/mycontracts";
...
export default {
  ...
  methods: {
    ...
    editNote() {
      console.log(this.data.contractNote);
    ...
    getData() {
      ...
      getMyContractsDetail(id).then((res) => {
