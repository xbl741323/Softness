        ...
        <div class="my_publish">
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <div v-if="showStatus == 0">
              <set-notice v-if="type==0" @getTitle="titleData"></set-notice>
              <set-policy v-if="type==1" @getTitle="titleData"></set-policy>
              <set-trouble v-if="type==2" @getTitle="titleData"></set-trouble>
            </div>
...
import setNotice from "@/components/personal/myPublish/setNotice";
import setPolicy from "@/components/personal/myPublish/setPolicy";
import setTrouble from "@/components/personal/myPublish/setTrouble";
import handleRecord from "@/components/personal/myPublish/handleRecord";
export default {
    components: {
        detailHead,
        setNotice,
