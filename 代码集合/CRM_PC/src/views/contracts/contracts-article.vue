    ...
    <div class="details">
      <div class="top-detail">
        ...
        <table class="table">
          ...
          <tr>
            <td>
              <span v-show="detail.taskStatus == '0'" class="circleBluec"></span>
              <span v-show="detail.taskStatus == '1'" class="successc"><b>✔</b></span>
      ...
      <div class="article-detail" v-if="detailarticle !=null">
        <setArticle @getTitle="titleData" :detailarticle="detailarticle" :detail="detail"></setArticle>
      </div>
      <!-- 审核记录 -->
...
export default {
  ...
  methods: {
    ...
    getData() {
      ...
      getartcileDetail(taskId).then((res) => {
