        ...
        <div v-if="!objData.repUrl">
          <el-row style="text-align: center">
            <el-col :span="12" class="col-select">
              <el-button type="success" @click="openMaterial">素材库选择<i class="el-icon-circle-check el-icon--right"></i>
              </el-button>
            </el-col>
      ...
      <el-row>
        <div class="select-item2" v-if="objData.repName">
          ...
          <div class="item-infos">
            <WxVoicePlayer
              :objData="Object.assign(tempPlayerObj,{repMediaId: objData.media_id, repName: objData.repName})"></WxVoicePlayer>
          </div>
          <el-row class="ope-row">
            <el-button type="danger" icon="el-icon-delete" circle @click="deleteObj"></el-button>
          </el-row>
    ...
    <el-tab-pane name="video">
      ...
      <el-row>
        ...
        <div style="text-align: center;">
          <a target="_blank" v-if="objData.repUrl" :href="objData.repUrl"><i
