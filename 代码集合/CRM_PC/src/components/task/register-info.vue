  ...
  <div class="new_register_info">
    ...
    <div class="basic_info_contain_parent" v-if="basicData.accountType == 1">
      ...
      <div class="basic_info_contain">
        ...
        <span>单位名称：</span>
         <span>
           <span v-if="(innerInfo.orgName&&innerInfo.orgName!==null) || (innerInfo.pwdOrgName&&innerInfo.pwdOrgName!==null)">{{ innerInfo.orgName || innerInfo.pwdOrgName}}</span>
       ...
       <div class="basic_info_contain">
        <div class="basic_info_item">
        <span>信用代码：</span>
         <span v-if="(basicData.creditCode!==null) || (basicData.pwdCreditCode!==null)">{{ basicData.creditCode || basicData.pwdCreditCode }}</span>
         <span v-else>暂无数据</span>
        </div>
      </div>
      <div class="basic_info_contain">
    ...
    <div class="basic_info_contain_parent">
      ...
      <div class="basic_info_item">
       ...
       <div class="basic_info_contain">
        ...
        <span>手&nbsp;&nbsp;机&nbsp;&nbsp;号：</span>
        <span>
          <span v-if="(basicData.phone!==null) || (basicData.accountNo!==null) ">{{basicData.phone || basicData.accountNo}}</span>
          <span v-else>{{$t('message.noData')}}</span>
        </span>
      </div>
       </div>
