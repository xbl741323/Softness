        ...
        <div class="userinfo-frame">
          ...
          <div class="deptinfo">
            <div class="deptinfo-item">
              <p>组织部门：</p>
              <p>{{userInfo.isPartner ? empInfo.partnerName : empInfo.deptName }}</p>
            </div>
            <div class="deptinfo-item">
              <p>联系电话：</p>
              <p>{{ phone }}</p>
    ...
    <div class="shareLink">
      ...
      <div class="table-link">
        <div v-for="(item,index) in appletLinkList" :key="index" class="applet-link-item">
          ...
          <span v-if="index == 0" data-clipboard-action="copy" :data-clipboard-text="wxYaoCode" @click="copyWx" class="copy_btn">{{item.title}}</span>
