    ...
    <el-form :model="filters" inline @keyup.enter.native="getAllList()">
      <el-form-item label="关键字：">
        <el-input
          ...
          placeholder="请输入操作人姓名/标题/内容关键字"></el-input>
      </el-form-item>
...
<script>
import { getUserEdit } from "@/api/admin/user";
import { getEmpInfo } from "@/api/project/wtClass";
import { tableOption } from "@/const/crud/user/edit-info";
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      let params = {
        keyId: this.$route.query.userId,
        keywords: this.filters.keyWords,
        startCreateTime:this.filters.createTime == null ? "": this.$moment(this.filters.createTime[0]).format("YYYY-MM-DD HH:mm:ss"),
        endCreateTime:this.filters.createTime == null? "": this.$moment(this.filters.createTime[1]).format("YYYY-MM-DD HH:mm:ss"),
