<template>
 <div>
  ...
  <div class="new_register_info">
    <!-- 单位客户 -->
    <div class="user_by_sty" v-if="basicData.accountType == 1">
    ...
    <div class="user_by_sty" v-else>
      ...
      <div class="basic_info_contain">
        ...
        <span class="span_left_sty">暂无数据</span>
        </div>
      </div>
      <div class="basic_info_contain">
        <div class="basic_info_item" v-if="innerInfo&&innerInfo.name!==null">
    ...
    <div class="user_by_sty">
      ...
      <div class="basic_info_contain">
         <div class="basic_info_item">
          <span>微信关注：</span>
          <span>{{ basicData.subscribeAccount | focusfilter }}</span>
      </div>
      </div>
      <div class="basic_info_contain">
      <div class="basic_info_item">
...
<script>
export default {
    props:['type','source','basicData','innerInfo','unitVO','dialog','showTitle'],
  data() {
    return {};
  },
  filters:{
