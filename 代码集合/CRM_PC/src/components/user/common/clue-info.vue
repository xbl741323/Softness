<template>
  <div class="new_clue_info">
    ...
    <div class="new_left_span">
      <span></span>
      <span>基本信息</span>
      <i class="el-icon-edit pointer_sty" v-if="type == 0" @click="openEditDialog('first')"></i>
    </div>
    <!-- 单位客户 -->
    ...
    <div class="basic_info_contain_parent">
    <!-- 线索编辑dialog -->
    <el-dialog :visible.sync="editClueDialog" title="补充用户信息" width="690px" :close-on-click-modal="false">
...
import operateClue from "@/components/user/common/operate-clue"
...
export default {
  ...
  props:['userData','type','clueOrganization','accountType','unitVO','phone'],
  data() {
    return {
      basicData:{},
      innerInfo:{},
