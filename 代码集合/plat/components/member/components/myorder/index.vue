            ...
            <div class="pay-info">
                  ...
                  <p>
                    {{
                      ...
                      ((item.orderStatus == 3 || item.orderStatus == 2) &&
                        ...
                        item.orderStatus == 4) && !('2,3,4'.includes(item.orderStatus) && item.payStatus == 0)
                        ? "已付"
                        : "应付"
                    }}
                  </p>
              ...
              <div class="general">
                <div class="amount-pay">
                  ...
                  <!-- <p v-if="item.contractType == 2 && item.orderStatus == 1" class="fontbig sign">待业务经理上传纸质合同</p> -->
                </div>
              </div>
              <!-- 操作 -->
                ...
                <div class="make-pay">
                  <p
                    v-if="
                      ...
                      (item.contractType == 1 ||
                        (item.contractType == 2 && item.contractStatus != 2)) && item.refundStatus != 4
                    "
                  ...
                  <!-- <p v-if="item.orderStatus == 1 && (item.contractType == 1 || (item.contractScope == 3 && item.contractType == 1 || item.contractType == 2 && item.contractStatus !=2))" class="torecom" @click="item.contractScope == 3 && (item.contractType == 1 || item.contractType == 2 && item.contractStatus !=2) ? signPrompt(item) : item.contractType == 1 ?  goSigncontract(item) : ''">{{item.contractScope == 3 ? '更换签约方式' :'去签约'}}</p> -->
                  <p
                    :class="
            ...
            <div class="refund-info">
              <div class="product-info" v-if="item">
                <div class="product-img">
                  ...
                  />
                  <div class="right-bar" @click="orderDetail(item, 1)">
                    <p class="product-name">{{ item.spuName }}</p>
                    <p class="order-type">
...
export default {
  ...
  methods: {
    ...
    filterType(item) {
      ...
      if (item.url && 'jpeg|png|jpg|gif'.match(suffix)) {
        return true;
      } else {
        return false;
      }
                  ...
                  if (item.payType == 1) {
                    ...
                    item.orderFeeList.forEach((fee) => {
                      ...
                      if (fee.payStatus == 1 && fee.payChannel == 1) {
                        ...
                        this.$set(ele, "payType", item.payType);
